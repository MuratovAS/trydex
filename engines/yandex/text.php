    ...
    if ($special_search != 0) {
        switch ($special_search) {
            ...
            case 6:
                ...
                break;
            case 7:
                $url = "https://ru.wikipedia.org/w/api.php?format=json&action=query&prop=extracts%7Cpageimages&exintro&explaintext&redirects=1&pithumbsize=500&titles=$query_encoded";
                break;
        }
